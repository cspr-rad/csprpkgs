...
symlinkJoin {
  ...
  paths = [
    ...
    (mkCctlCommand "tx-dispatch-native-transfer" "chain/tx/dispatch_transfer_native")
    (mkCctlCommand "tx-dispatch-native-transfer-batch" "chain/tx/dispatch_transfer_native_batch")
    (mkCctlCommand "tx-dispatch-wasm-transfer" "chain/tx/dispatch_transfer_native_batch")
    (mkCctlCommand "tx-dispatch-wasm-transfer-batch" "chain/tx/dispatch_transfer_wasm_batch")
    (mkCctlCommand "tx-prepare-native-transfer-batch" "chain/tx/prepare_transfer_native_batch")
    (mkCctlCommand "tx-prepare-wasm-transfer-batch" "chain/tx/prepare_transfer_wasm_batch")
  ];
}
